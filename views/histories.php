...
if (!isset($_SESSION["user"]) || !isset($_SESSION["user"]["id"])) {
    ...
    exit; // Thêm exit để dừng script ngay sau redirect
}
$_REQUEST["pos"] = "";
...
// echo "<pre>";
// var_dump($user->getUser_id()); // Kiểm tra user_id
// var_dump($bills); // Kiểm tra danh sách bills
// echo "</pre>";
        ...
        <div class="container">
            ...
            if (count($bills) > 0) {
                foreach ($bills as $bill) {
                    // Debug: Kiểm tra bill_customer_id của mỗi hóa đơn
                    // echo "Bill ID: " . $bill->getBill_id() . " - Customer ID: " . $bill->getBill_customer_id() . "<br>";
            ?>
                <div class="
                    history-row
                    d-flex
                    ...
                    <div class="history-infor d-flex align-items-center">
                        <a data-bs-toggle="collapse"
                            ...
                            aria-controls="multiCollapseExample<?=$bill->getBill_id()?>">
                    ...
                    <div class="history-dropdown">
                            ...
                            ?>
                                ...
                                <li>
                                    <button class="dropdown-item py-0 text-danger"
                                        ...
                                        data-bs-target="#modalCancelBill<?=$bill->getBill_id()?>">
                                        Hủy đơn
                                    </button>
                                </li>
                            <?php
                        ...
                        <div class="modal fade"
                            id="modalCancelBill<?=$bill->getBill_id()?>"
                        ...
                        <div class="collapse multi-collapse"
                            ...
                            <div class="card card-body mb-3">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9"><?=$bill->getBillstatic_name()?></div>
                                </div>
                                <div class="row mb-2">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        '<span class="text-danger me-1">Không</span><span>(Đơn đặt phòng đã bị hủy)</span>'?>
                                    </div>
                                </div>
                            </div>
                        </div>
